...
HTML_REPORTS = [
    ...
    "publish_media_kit/executive_viral_brief.md",
...
def dashboard_data() -> dict[str, object]:
    ...
    executive_brief = {
        ...
        "subhead": (
            "A non-technical, evidence-backed brief for executives, founders, and journalists: "
            "VivaTech's public listings show a startup-heavy marketplace and a partner-heavy matched speaker layer."
        ),
        "heroCopy": (
            "VivaTech can keep sponsorship and still protect trust: sell visibility openly, "
            "but choose the main stage through an editorial board with published criteria. "
            "Otherwise the event risks making startups function as the background cast for big-company marketing campaigns."
        ),
        "oneMinuteRead": [
            {
                "label": "What the floor says",
                "headline": "The marketplace is overwhelmingly startups.",
                "metric": f"{metrics['startup_pct']:.1f}% startups",
                "evidence": f"{metrics['startup_count']:,} of {metrics['companies']:,} exhibitor records are startups.",
                "soWhat": "This scale supplies the event's startup atmosphere; the controversy is that the atmosphere does not translate into matching microphone power.",
            },
            {
            ...
            {
                "label": "Why this can travel",
                "headline": "It is not an AI story. It is a power story.",
                "metric": f"Gini {more_metrics['attention_gini']:.3f}",
                "evidence": "Matched speaker visibility is highly concentrated when zero-speaker exhibitors are included.",
                "soWhat": "The clean public question is who gets the microphone, not which topic has the most booths.",
            },
            {
                "label": "The reform",
                "headline": "Separate editorial selection from partnership incentives.",
                "metric": "board, criteria, disclosures",
                "evidence": "The critique is structural; no sponsorship-causality claim is needed.",
                "soWhat": "A better model protects sponsors, founders, and the event brand by labeling commerce and governing the stage.",
            },
        ],
        "viralHooks": [
            {
                "audience": "founders",
                "tone": "sharp",
                "hook": "VivaTech's startup floor is real. Its microphone layer tells a partner story.",
                "proof": "Startups are 86.2% of exhibitors but 22.8% of matched speaker slots.",
                "caveat": "Public listings and conservative matching; not proof that any slot was sold.",
            },
            {
                "audience": "executives",
                "tone": "boardroom",
                "hook": "The risk is not sponsorship. The risk is letting sponsorship logic govern the stage.",
                "proof": "Partners are 13.8% of exhibitors and 77.2% of matched speaker slots.",
                "caveat": "This supports a governance critique, not a claim about internal intent.",
            },
            {
                "audience": "media",
                "tone": "headline",
                "hook": "VivaTech looks like a startup marketplace from the floor and an institutional forum from the microphone.",
                "proof": "Only 191 of 3,153 exhibitors have a matched speaker.",
                "caveat": "Conservative matching may undercount true organization links.",
            },
            {
                "audience": "policy",
                "tone": "governance",
                "hook": "A major tech forum should publish how the main stage is selected.",
                "proof": "Attention concentrates sharply: the exhibitor-level matched-speaker Gini is "
                f"{more_metrics['attention_gini']:.3f}.",
                "caveat": "Visibility concentration is not the same thing as business value or merit.",
            },
            {
                "audience": "founders",
                "tone": "provocation",
            ...
            },
            {
                "audience": "media",
                "tone": "safe",
                "hook": "This is the cleanest VivaTech question: who gets amplified after the booths are counted?",
                "proof": "3,153 companies, 1,133 speakers, 355 matched speakers, 191 companies with matched speakers.",
                "caveat": "The analysis measures public listing visibility, not private agenda negotiations.",
            },
        ],
        "messageHouse": {
            "safeToSay": [
            ...
            "doNotSay": [
                "Do not say a specific stage slot was sold.",
                "Do not say sponsors caused every speaker placement.",
                "Do not say startups were excluded; say their matched visibility is lower than their floor share.",
            ],
            "executiveQuestion": "If the main stage is the event's front page, who is the editor: an editorial board or partnership development?",
        },
        "boardroomMoves": [
            "Publish speaker-selection criteria before the event.",
            "Separate stage curation from partnership-development targets.",
            "Disclose sponsor/partner relationships next to sponsor-led sessions.",
            "Reserve explainable stage inventory for startups, public-interest topics, and non-sponsor voices.",
        ],
    }
    ...
    conclusion_support = [
        ...
        {
            "pattern": "Startups as marketing backdrop",
            "evidence": "Startups are 86.2% of exhibitors but 22.8% of matched speaker slots; partners are 13.8% of exhibitors but 77.2% of matched speaker slots.",
            "interpretation": "A sharp but defensible reading is that startups supply the event's energy while large partner-class organizations receive disproportionate public agenda visibility.",
            "caveat": "This is about public matched-speaker visibility, not a claim about any company's internal campaign plan.",
        },
        {
...
def main() -> None:
    ...
    write_text(DASH / ".nojekyll", "")
    write_text(DASH / ".gitignore", "validation_*.png\n")
    write_text(
        DASH / "README.md",
        textwrap.dedent(
            """\
